      ...
      <a class="navbar-brand text-white" href="#">Welcome Admin! | <b>Speri-Guds</b></a>
        ...
        <div class="icon ml-4">
          <h5>
            ...
            <a href="login.php"><i class="fas fa-sign-out-alt bg-primary mr-3 text-white" data-toggle="tooltip" title="Sign Out"></i></a>
          </h5>
        </div>
      </div>
    </nav>
        ...
        <div class="row text-white mb-3">
          ...
          <div class="card bg-success ml-5" style="width: 18rem;">
            <div class="card-body">
              ...
              <h5 class="card-title">Jumlah Sparepart</h5>
              <div class="display-4">1524</div>
              <a href="sparepart.php"><p class="card-text text-white">Lihat Detail <i class="fas fa-tools-double-right ml-2"></i></p></a>
            </div>
          </div>
