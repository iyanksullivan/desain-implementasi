          ...
          <tbody>
            ...
            <tr><?php foreach ($user as $usr) : ?>
              ...
              <td>
                ...
                <a href="<?php echo site_url('ControllerUser/deleteUserAdmin/'.$usr['username']);?>"><i class="fas fa-trash bg-danger text-white p-2 rounded" data-toggle="tooltip" title="Hapus"></i></i></a>
              </td>
            </tr>     
            <?php $n++; ?>                 
            <?php endforeach ?>            
