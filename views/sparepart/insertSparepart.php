    ...
    <div class="row no-gutters mt-5">
      <div class="col-xl-2 bg-dark mt-2 pr-3 pt-4">
          <ul class="nav flex-column ml-3 mb-5">
              ...
              <li class="nav-item">
                <a class="nav-link text-white" href="obat.php"><i class="fas fa-pills mr-2"></i>Daftar Obat</a><hr class="bg-secondary">
              </li>
              <li class="nav-item">
      ...
      <div class="col-xl-10 p-5 pt-2">
          <h3><i class="fas fa-pills mr-2"></i>Masukkan Data Obat</h3><hr>
            <div class="row">
              <div class="col-lg-8">
                ...
                <form method="post">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="namaobat" name="nama">
                    </div>
                  </div>
                  <div class="form-group row">
