              ...
              <div class="col-lg-8">
                <form method="post" action="">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="namaobat" name="nama" value="<?= $obat['nama']; ?>" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="jenis" class="col-sm-2 col-form-label">Jenis</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="jenis" name="jenis" value="<?= $obat['jenis']; ?>"disabled>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="harga" class="col-sm-2 col-form-label">Harga</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="harga" name="harga" value="<?= $obat['harga']; ?>"disabled>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div class="row">
                        <div class="col-sm-3">
                          <img src="<?php echo base_url(); ?>assets/fotoobat/<?php echo $obat['foto'] ?>"widht="50" height="65">
                        </div>
                        <div class="col-sm-9">
                        </div>
                      </div>
