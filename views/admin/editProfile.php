    ...
    <div class="row no-gutters mt-5">  
      ...
      <div class="col-xl-10 p-5 pt-2">
          <h3><i class="fas fa-user mt-5 mr-2"></i>Edit Profile</h3><hr>
            <div class="row">
              <div class="col-lg-8">
               <?php echo form_open_multipart('ControllerAdm/update');?>
                  <div class="form-group row">
                    <label for="username" class="col-sm-2 col-form-label">Username</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control form-control-plaintext" id="username" name="username" value="<?= $admin['username']; ?>">
                    </div>
                  </div>                  
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <div class="row">
                        <div class="col-sm-3">
                          <img src="<?php echo base_url(); ?>assets/fotoadmin/<?php echo $admin['foto'] ?>" class="img-thumbnail">
                        </div>
                        <div class="col-sm-9">
            ...
            <div class="row">
              <div class="col-sm-10">
              <a href="<?php echo site_url('ControllerAdm/delete/'.$admin['username']);?>" onclick="return confirm('Apakah anda yakin menghapus akun ini?');"><i class="fas fa-trash bg-danger text-white p-2 rounded" data-toggle="tooltip" title="Hapus" ></i></i></a>
              </div>
            </div>
